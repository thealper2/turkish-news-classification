...
print(f"LSTM Train Score = {simplernn_train_score * 100:.4f}%")
print(f"LSTM Test Score = {simplernn_test_score * 100:.4f}%")
...
print(f"LSTM Precision Score = {simplernn_precision_score * 100:.4f}%")
print(f"LSTM F1 Score = {simplernn_f1_score * 100:.4f}%")
print(f"LSTM Recall Score = {simplernn_recall_score * 100:.4f}%")
print(f"LSTM Accuracy Score = {simplernn_accuracy_score * 100:.4f}%")
